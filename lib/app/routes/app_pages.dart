...
import '../modules/auto_face_login/bindings/auto_face_login_binding.dart';
import '../modules/auto_face_login/views/auto_face_login_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.AUTO_FACE_LOGIN,
      page: () => const AutoFaceLoginView(),
      binding: AutoFaceLoginBinding(),
    ),
  ];
}
